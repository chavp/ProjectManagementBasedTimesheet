Ext.define(document.appName + '.view.project.ProjectActivitiesPanel', {
            ...
            items: [{
                ...
                items: [{
                                                ...
                                                record.erase({
                                                    success: function (record, operation) {
                                                        Ext.MessageBox.show({
                                                            ...
                                                            fn: function (btn) {
                                                                //self.phaseStore.commitChanges();
                                                            }
                                                        });
                                                    },
                                                    failure: function (record, operation) {
                                                        self.phaseStore.load();
                                                    }
                                                });
                                            }
                                        });
                    ...
                    , bbar: Ext.create('Ext.PagingToolbar', {
                        store: self.phaseStore,
                        displayInfo: true,
                        displayMsg: TextLabel.projectPhaseLabel + ' ที่กำลังแสดงอยู่ {0} - {1} จาก {2}',
                        emptyMsg: "ไม่มี " + TextLabel.projectPhaseLabel
                    })
                }, {
                    ...
                    tbar: [{
                        ...
                        handler: function (btn, evt) {
                            var addForm = Ext.create('widget.taskTypeWindow', {
                                ...
                                modal: true,
                                taskTypeStore: self.taskTypeStore,
                                order: self.taskTypeStore.count() + 1
                            });
                            addForm.show();
                        }
                    }]
                    ...
                    , bbar: Ext.create('Ext.PagingToolbar', {
                        store: self.taskTypeStore,
                        displayInfo: true,
                        displayMsg: TextLabel.taskTypeLabel + ' ที่กำลังแสดงอยู่ {0} - {1} จาก {2}',
                        emptyMsg: "ไม่มี " + TextLabel.taskTypeLabel
                    })
                }, {
                    ...
                    , bbar: Ext.create('Ext.PagingToolbar', {
                        store: self.mainTaskStore,
                        displayInfo: true,
                        displayMsg: TextLabel.mainTaskLabel + ' ที่กำลังแสดงอยู่ {0} - {1} จาก {2}',
                        emptyMsg: "ไม่มี " + TextLabel.mainTaskLabel
                    })
                }]
            }]
        });
